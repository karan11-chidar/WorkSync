...
/**
 * Renders the task board heading and task creation action.
 *
 * @param {Object} props - Header props.
 * @param {Function} props.setIsOpenTask - Opens or closes the task form.
 * @param {Function} props.setEditingTask - Sets the task being edited.
 * @returns {JSX.Element} The task board header.
 */
    ...
    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 bg-white p-6 rounded-2xl border border-slate-100 shadow-xs">
      <div>
        ...
        <p className="text-[0.725rem] lg:text-sm text-slate-500 mt-1">
          Assign, trace, and manage critical deliverables across your workforce.
        </p>
      </div>
      <button
        onClick={() => {
